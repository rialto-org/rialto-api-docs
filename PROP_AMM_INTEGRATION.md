...
price/quote function and settle atomically in the same transaction — **not**
off-chain RFQ/PMM signing.

If you run an RFQ desk that signs quotes off-chain, that's a different integration
— talk to us; this guide does not cover it.
